...
**1) Код**
    ...
    print(f"\nВывод:")
    print(f"Оба генератора демонстрируют результаты, близкие к теоретическим.")
    print(f"Встроенный генератор показывает незначительно лучшую точность,")
    print(f"что объясняется более сложным алгоритмом (Mersenne Twister).")
    print(f"Самодельный LCG-датчик, несмотря на простоту, обеспечивает")
    print(f"статистические характеристики, достаточные для многих прикладных задач.")
